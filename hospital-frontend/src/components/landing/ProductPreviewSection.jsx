  ...
  return (
    <section className="mx-auto max-w-7xl px-4 py-12 sm:py-14 lg:px-6">
      <div className="mb-8">
        ...
        <h2 className="mt-2 text-2xl font-bold text-slate-900 sm:text-3xl">{t("home.productPreviewTitle")}</h2>
      </div>
      ...
      <div className="grid gap-4 md:grid-cols-3">
        {previews.map((item, i) => (
          ...
          >
            <div className="mb-4 flex h-32 items-center justify-center rounded-2xl bg-gradient-to-br from-brand-50 to-cream-100 sm:h-40">
